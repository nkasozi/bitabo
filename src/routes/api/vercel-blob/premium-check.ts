 ...
 * 
 * @param pathname The pathname to extract prefix from
 * @returns The extracted prefix or null if not found
 */
export function extractPrefixFromPathname(pathname: string): string | null {
